...
$(document).ready(function (){
  ...
  function showImg(e){
    var i;
    const img = document.querySelectorAll('.hero-content img');
    const sliders = document.querySelectorAll('.btn-sliders span');
    if(e > img.length){indexValue = 1;}
    if(e < 1){indexValue = img.length;}
    var e_backup_value = e;
    ...
    sliders[indexValue-1].style.background = "#FC3222";
    ...
    function showSlides(){
        var i;
        var slides = document.querySelectorAll('.hero-content img');
        const dots = document.querySelectorAll('.btn-sliders span');
        ...
        dots[slideIndex-1].style.background = "#FC3222";
